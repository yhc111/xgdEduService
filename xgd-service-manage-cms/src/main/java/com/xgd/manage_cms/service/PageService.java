package com.xgd.manage_cms.service;
...
import com.xgd.framework.domain.cms.response.CmsCode;
...
import com.xgd.framework.model.response.*;
import com.xgd.manage_cms.config.RabbitmqConfig;
import com.xgd.manage_cms.dao.CmsConfigRepository;
import com.xgd.manage_cms.dao.CmsPageRepository;
import com.xgd.manage_cms.dao.CmsSiteRepository;
import com.xgd.manage_cms.dao.CmsTemplateRepository;
...
//        // 根据页面名称、站点ID、页面webpath去cms_page集合查询，如果查到，说明此页面已经存在，如果查询不到再添加
